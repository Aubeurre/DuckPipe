namespace DuckPipe
{
    partial class CreateProductionPopup
    {
        ...
        private void InitializeComponent()
        {
            ...
            ListViewItem listViewItem16 = new ListViewItem("nk");
            ListViewItem listViewItem17 = new ListViewItem(new string[] { "Rig" }, -1, Color.Orange, Color.Empty, null);
            ListViewItem listViewItem18 = new ListViewItem("spp");
            ListViewItem listViewItem19 = new ListViewItem(new string[] { "Surf" }, -1, Color.RoyalBlue, Color.Empty, null);
            ListViewItem listViewItem20 = new ListViewItem("ztl");
            label1 = new Label();
