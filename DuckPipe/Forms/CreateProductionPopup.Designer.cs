...
namespace DuckPipe
{
    partial class CreateProductionPopup
    {
        ...
        private void InitializeComponent()
        {
            ...
            ListViewItem listViewItem12 = new ListViewItem("hipnc");
            ListViewItem listViewItem13 = new ListViewItem(new string[] { "Layout" }, -1, Color.LimeGreen, Color.Empty, null);
            ListViewItem listViewItem14 = new ListViewItem(new string[] { "Light" }, -1, Color.Gold, Color.Empty, null);
            ListViewItem listViewItem15 = new ListViewItem("ma");
            ListViewItem listViewItem16 = new ListViewItem(new string[] { "Model" }, -1, Color.LightSkyBlue, Color.Empty, null);
            ListViewItem listViewItem17 = new ListViewItem("nk");
            ListViewItem listViewItem18 = new ListViewItem("psd");
            ListViewItem listViewItem19 = new ListViewItem(new string[] { "Rig" }, -1, Color.Orange, Color.Empty, null);
            ListViewItem listViewItem20 = new ListViewItem("spp");
            ListViewItem listViewItem21 = new ListViewItem(new string[] { "Surf" }, -1, Color.RoyalBlue, Color.Empty, null);
            ListViewItem listViewItem22 = new ListViewItem("ztl");
            label1 = new Label();
