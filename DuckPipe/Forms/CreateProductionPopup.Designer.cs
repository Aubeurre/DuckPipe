namespace DuckPipe
{
    partial class CreateProductionPopup
    {
        ...
        private void InitializeComponent()
        {
            ...
            ListViewItem listViewItem1 = new ListViewItem("Anim");
            ListViewItem listViewItem2 = new ListViewItem("Assemble");
            ListViewItem listViewItem3 = new ListViewItem("blend");
            ListViewItem listViewItem4 = new ListViewItem("Board");
            ListViewItem listViewItem5 = new ListViewItem("Cfx");
            ListViewItem listViewItem6 = new ListViewItem("CfxShot");
            ListViewItem listViewItem7 = new ListViewItem("Comp");
            ListViewItem listViewItem8 = new ListViewItem("Concept");
            ListViewItem listViewItem9 = new ListViewItem("Facial");
            ListViewItem listViewItem10 = new ListViewItem("Fx");
            ListViewItem listViewItem11 = new ListViewItem("Groom");
            ListViewItem listViewItem12 = new ListViewItem("Layout");
            ListViewItem listViewItem13 = new ListViewItem("Light");
            ListViewItem listViewItem14 = new ListViewItem("ma");
            ListViewItem listViewItem15 = new ListViewItem("Model");
            ListViewItem listViewItem16 = new ListViewItem("Rig");
            ListViewItem listViewItem17 = new ListViewItem("spp");
            ListViewItem listViewItem18 = new ListViewItem("Surf");
            label1 = new Label();
